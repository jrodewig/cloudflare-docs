...
| [FaunaDB](https://docs.fauna.com/fauna/current/)                                                          | [Yes](/workers/databases/native-integrations/fauna/)       | [faunadb](https://github.com/fauna/fauna-js)                                       | API via client library                                             |
