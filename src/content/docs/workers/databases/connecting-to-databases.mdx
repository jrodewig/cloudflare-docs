...
| [Fauna](https://docs.fauna.com/fauna/current/)                                                            | [Yes](/workers/databases/native-integrations/fauna/)       | [fauna](https://github.com/fauna/fauna-js)                                         | API through client library                                         |
